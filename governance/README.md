...
| [IAR-0007-founding-adopter-window.md](IAR-0007-founding-adopter-window.md) | Adopter register (`registry/adopters.json`) and the founding-adopter window; the window closes with IAR-0006, the register does not | In force; Tier 1, no comment period |
